...
1. Importing the text into the system and scheduling when the newly
   created topic will be shown to you.
...
Mir automatically schedules reviews for you, thereby increasing your
familiarity with the text and strengthening the memory of the concepts
...
are important: you'll see high-priority items first.
...
Be careful if you want to use the snippet above, however, as currently
extracts from eww buffers are unreliable. This is a known issue.
