...
"Philosophy" section below for more details.
...
items have a lower priority value. Thus, an item with the priority
value 0 is the most important in the collection and will appear
earlier.
...
keyword =archive= being added to it. The dismissed topic will also be
kept around in the database. Dismissal is preferred over deletion, as
it prevents accidental loss of important topics.
...
Mir implements a part of incremental reading as seen in SuperMemo.

Using mir eventually results in many repetitions of seeing the same
material. This can be both benefitial and detrimental and that depends
on your relationship with the material. If you find the material
incomprehensible, boring, too heavy or generally unsuitable to your
present needs, mir will amplify these feelings tenfold by showing the
material over and over again. Thus, mir is best used with material
that you find inherently interesting---that you'd study even if no one
told you to look into it.
